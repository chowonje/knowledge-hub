#!/usr/bin/env python
"""Build a report-only parsed artifact source recovery feasibility report."""
...
DEFAULT_OUTPUT_DIR = Path(
    "~/.khub/reports/parsed-artifact-coverage/2026-05-20/parsed-artifact-source-recovery-feasibility"
).expanduser()
...
def main() -> int:
    ...
    parser.add_argument("--report-name", default="parsed-artifact-source-recovery-feasibility")
    ...
    paths = write_parsed_artifact_source_recovery_feasibility(report, args.output_dir)
    print(
        json.dumps(
            {
                ...
                "sourceBlockerSnapshot": report["sourceBlockerSnapshot"],
                "localScanSummary": report["localScanSummary"],
                "sourceMissingRecoverySummary": report["sourceMissingRecoverySummary"],
                "oversizedPolicySummary": report["oversizedPolicySummary"],
                "textSourcePolicySummary": report["textSourcePolicySummary"],
