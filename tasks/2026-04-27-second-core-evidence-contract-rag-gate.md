...
- The completed full live baseline used `python eval/knowledgeos/scripts/run_evidence_contract_perf_gate.py --json --timeout-sec 20`.
...
- `python -m pytest tests/test_evidence_contract_perf_gate.py -q` (`6 passed`)
...
- `python eval/knowledgeos/scripts/run_evidence_contract_perf_gate.py --json --timeout-sec 20` (`status=failed`, `6/24` cases passed; baseline recorded only, not CI-required)
- `python -m pytest tests/test_answer_contracts_runtime.py tests/test_answer_contract_schemas.py tests/test_answer_quality_gate.py tests/test_retrieval_span_golden.py tests/test_evidence_contract_perf_gate.py -q` (`24 passed`)
