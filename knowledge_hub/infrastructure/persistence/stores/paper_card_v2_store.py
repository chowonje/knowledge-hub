...
class PaperCardV2Store:
    ...
    def ensure_schema(self) -> None:
        ...
        add_derivative_lifecycle_columns(self.conn, "paper_cards_v2", _add_column_if_missing)
        self.conn.execute(
            """
    ...
    def upsert_card(self, *, card: dict[str, Any]) -> dict[str, Any]:
        ...
        self.conn.execute(
            ...
            INSERT INTO paper_cards_v2 (
                ...
                diagnostics_json, source_content_hash, stale, stale_reason, invalidated_at,
