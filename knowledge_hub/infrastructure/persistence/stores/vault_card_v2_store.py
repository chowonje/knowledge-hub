...
class VaultCardV2Store:
    ...
    def ensure_schema(self) -> None:
        ...
        add_derivative_lifecycle_columns(self.conn, "vault_cards_v2", _add_column_if_missing)
    ...
    def upsert_card(self, *, card: dict[str, Any]) -> dict[str, Any]:
        ...
        source_hash = resolve_source_content_hash(self.conn, payload, document_id=note_id)
        self.conn.execute(
            """
            INSERT INTO vault_cards_v2 (
                ...
                slot_coverage_json, diagnostics_json, source_content_hash, stale,
                stale_reason, invalidated_at, created_at, updated_at
