...
def help_advanced():
    ...
    click.echo("  paper materialize-parsed, paper layout-parser-pilot")
    click.echo("  paper source-freshness, paper canon-quality-audit")
    click.echo("  paper normalize-concepts")
