...
@click.option("--repo-path", default="", help="Workspace git worktree path (defaults to current cwd)")
...
@click.option("--repo-path", default="", help="Workspace git worktree path passed to task-context step")
