...
VISUAL_RETRIEVAL_HINT_CANDIDATE_STORE_DESIGN_SCHEMA_ID = (
    "knowledge-hub.paper.visual-retrieval-hint-candidate-store-design.v1"
)
VISUAL_RETRIEVAL_HINT_CANDIDATE_ROW_SCHEMA_ID = (
    "knowledge-hub.paper.visual-retrieval-hint-candidate-row.v1"
)

READY_DECISION = "ready_for_visual_retrieval_hint_candidate_store_dry_run"
NEXT_RECOMMENDED_TRANCHE = "visual_retrieval_hint_candidate_store_dry_run"
...
def _full_image_escalation_policy() -> dict[str, Any]:
    return {
        ...
        "requiresBeforeFullImageGpt": [
            "visual_retrieval_hint_candidate_store_design",
            "visual_retrieval_hint_candidate_store_dry_run",
...
def build_visual_retrieval_hint_candidate_store_design(
    validation_report: dict[str, Any],
    *,
    source_validation_report_ref: str = "eval/knowledgeos/reports/visual_annotation_web_output_001.validation.v1.json",
    ...
    if (
        validation_report.get("schema") != VISUAL_ANNOTATION_WEB_OUTPUT_VALIDATION_SCHEMA_ID
...
def write_visual_retrieval_hint_candidate_store_design(
    report: dict[str, Any],
    *,
    report_json: Path,
    report_md: Path,
