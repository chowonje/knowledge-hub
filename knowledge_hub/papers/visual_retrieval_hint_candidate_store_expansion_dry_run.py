...
VISUAL_RETRIEVAL_HINT_CANDIDATE_STORE_EXPANSION_DRY_RUN_ROW_SCHEMA_ID = (
    "knowledge-hub.paper.visual-retrieval-hint-candidate-store-expansion-dry-run-row.v1"
)

READY_DECISION = "ready_for_visual_retrieval_hint_candidate_store_expansion_review"
NEXT_RECOMMENDED_TRANCHE = "visual_retrieval_hint_candidate_store_expansion_review"
...
def _dry_run_row(row: dict[str, Any], *, source_design_report_ref: str) -> dict[str, Any]:
    ...
    return {
        "schema": VISUAL_RETRIEVAL_HINT_CANDIDATE_STORE_EXPANSION_DRY_RUN_ROW_SCHEMA_ID,
        ...
        "provenance": {
            "sourceDesignReportSchema": VISUAL_RETRIEVAL_HINT_CANDIDATE_STORE_EXPANSION_DESIGN_SCHEMA_ID,
            "sourceDesignReportRef": normalize_text(source_design_report_ref),
            "sourceCandidateId": normalize_text(record.get("sourceCandidateId")),
            "sourceContentHash": normalize_text(record.get("sourceContentHash")),
            "page": int(record.get("page") or 0),
            "bbox": list(record.get("bbox") or []),
            "extractionMethod": "visual_retrieval_hint_candidate_store_expansion_dry_run_v1",
        },
...
def build_visual_retrieval_hint_candidate_store_expansion_dry_run(
    design_report: dict[str, Any],
    *,
    source_design_report_ref: str = "eval/knowledgeos/reports/visual_retrieval_hint_candidate_store_expansion_design.v1.json",
    ...
    if (
        design_report.get("schema") != VISUAL_RETRIEVAL_HINT_CANDIDATE_STORE_EXPANSION_DESIGN_SCHEMA_ID
...
def write_visual_retrieval_hint_candidate_store_expansion_dry_run(
    report: dict[str, Any],
    *,
    report_json: Path,
    report_md: Path,
