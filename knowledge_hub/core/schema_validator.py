...
SCHEMA_NAME_BY_ID = {
    ...
    "knowledge-hub.paper.strict-evidence-runtime-binding-visibility-executor-dry-run.v1": "paper-strict-evidence-runtime-binding-visibility-executor-dry-run.v1.json",
