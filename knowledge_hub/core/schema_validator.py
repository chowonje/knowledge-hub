...
SCHEMA_NAME_BY_ID = {
    ...
    "knowledge-hub.paper.text-complex-qa-eval-alignment-case.v1": "paper-text-complex-qa-eval-alignment-case.v1.json",
    ...
    "knowledge-hub.paper.text-evidence-pr149-disposition.v1": "paper-text-evidence-pr149-disposition.v1.json",
    ...
    "knowledge-hub.paper.text-evidence-canonical-dirty-snapshot-dry-run.v1": "paper-text-evidence-canonical-dirty-snapshot-dry-run.v1.json",
    "knowledge-hub.paper.text-evidence-rc-text-only-scope-gate.v1": "paper-text-evidence-rc-text-only-scope-gate.v1.json",
    "knowledge-hub.paper.text-evidence-rc-external-action-preflight.v1": "paper-text-evidence-rc-external-action-preflight.v1.json",
    "knowledge-hub.paper.text-evidence-rc-pr149-close-approval-request.v1": "paper-text-evidence-rc-pr149-close-approval-request.v1.json",
    "knowledge-hub.paper.text-evidence-rc-pr149-close-receipt.v1": "paper-text-evidence-rc-pr149-close-receipt.v1.json",
