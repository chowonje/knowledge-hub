    ...
    tools = [
        ...
        Tool(
            ...
            "properties": {
                ...
                "paperQueryRun": {"type": "string", "description": "validated paper-harness query run directory for explicit qwen8 paper evidence"},
                "paperQueryId": {"type": "string", "description": "query id inside paperQueryRun"},
                "paperQwenNamespace": {"type": "string", "description": "qwen8 paper vector namespace"},
                "paperQwenModel": {"type": "string", "description": "qwen8 query embedding model"},
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "create_obsidian_note": {
                        "type": "boolean",
                        "description": "Obsidian vault에 노트 생성 (명시적 옵트인)",
                        "default": False,
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "create_obsidian_note": {
                        "type": "boolean",
                        "description": "Obsidian vault에 요약 노트 생성 (명시적 옵트인)",
                        "default": False,
                    },
