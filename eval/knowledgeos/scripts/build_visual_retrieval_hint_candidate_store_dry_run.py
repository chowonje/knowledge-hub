#!/usr/bin/env python3
"""Build the report-only visual retrieval hint candidate-store dry-run."""
...
DEFAULT_MD_PATH = (
    PROJECT_ROOT / "eval/knowledgeos/reports/visual_retrieval_hint_candidate_store_dry_run.v1.md"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.no_write:
        paths = write_visual_retrieval_hint_candidate_store_dry_run(
            report,
