#!/usr/bin/env python3
"""Build the report-only visual annotation expansion pack design."""
...
DEFAULT_MD_PATH = (
    PROJECT_ROOT / "eval/knowledgeos/reports/visual_annotation_expansion_pack_design.v1.md"
)
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--source-dry-run", type=Path, default=DEFAULT_DRY_RUN_PATH)
    ...
    parser.add_argument("--pack-id", default=DEFAULT_EXPANSION_PACK_ID)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "visual annotation expansion pack design schema validation failed: "
