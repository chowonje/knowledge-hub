#!/usr/bin/env python3
"""Build the KnowledgeOS v0.1 RC post-merge convergence cleanup decision."""
...
DEFAULT_JSON_PATH = PROJECT_ROOT / "eval/knowledgeos/reports/knowledgeos_v01_rc_post_merge_convergence_cleanup_decision.v1.json"
DEFAULT_MD_PATH = PROJECT_ROOT / "eval/knowledgeos/reports/knowledgeos_v01_rc_post_merge_convergence_cleanup_decision.v1.md"
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--vision-bottleneck-report", type=Path, default=DEFAULT_VISION_BOTTLENECK_REPORT)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_knowledgeos_v01_rc_post_merge_convergence_cleanup_decision(
        vision_bottleneck_report_path=args.vision_bottleneck_report,
        git_state=git_state,
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "KnowledgeOS v0.1 RC post-merge convergence cleanup decision schema validation failed: "
