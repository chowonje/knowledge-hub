#!/usr/bin/env python3
"""Build the post-merge convergence report for PR #176 controlled execution."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_knowledgeos_v01_rc_corpus_scale_controlled_execution_post_merge_convergence(
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "KnowledgeOS v0.1 RC controlled execution post-merge convergence schema validation failed: "
