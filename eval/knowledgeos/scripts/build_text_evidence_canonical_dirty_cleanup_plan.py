#!/usr/bin/env python
"""Build the v0.1 text-evidence canonical dirty cleanup plan report."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_cleanup_plan.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_cleanup_plan.v1.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_text_evidence_canonical_dirty_cleanup_plan_report(reports_root=REPORTS_ROOT)
