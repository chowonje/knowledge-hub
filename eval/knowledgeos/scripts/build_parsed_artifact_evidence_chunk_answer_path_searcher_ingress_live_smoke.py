#!/usr/bin/env python3
"""Build parsed-artifact evidence chunk answer-path searcher ingress live smoke."""
...
DEFAULT_MD_PATH = (
    PROJECT_ROOT
    / "eval/knowledgeos/reports/parsed_artifact_evidence_chunk_answer_path_searcher_ingress_live_smoke.v1.md"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "parsed artifact evidence chunk answer path searcher ingress live smoke schema validation failed: "
