#!/usr/bin/env python
"""Build report-only SectionSpan and ParagraphSpan text candidates."""
...
DEFAULT_JSON_PATH = PROJECT_ROOT / "eval" / "knowledgeos" / "reports" / "text_section_paragraph_span_artifacts.v1.json"
DEFAULT_MD_PATH = PROJECT_ROOT / "eval" / "knowledgeos" / "reports" / "text_section_paragraph_span_artifacts.v1.md"
