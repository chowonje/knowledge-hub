#!/usr/bin/env python
"""Build the v0.1 text-evidence canonical dirty snapshot dry-run report."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_snapshot_dry_run.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_snapshot_dry_run.v1.md"
