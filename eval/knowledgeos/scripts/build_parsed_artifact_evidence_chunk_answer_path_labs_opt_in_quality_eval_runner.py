#!/usr/bin/env python3
"""Build parsed-artifact evidence chunk labs opt-in quality eval runner."""
...
from knowledge_hub.papers.parsed_artifact_evidence_chunk_answer_path_labs_opt_in_quality_eval_runner import (
    DEFAULT_QUALITY_EVAL_SEED_REPORT,
...
DEFAULT_MD_PATH = (
    PROJECT_ROOT
    / "eval/knowledgeos/reports/parsed_artifact_evidence_chunk_answer_path_labs_opt_in_quality_eval_runner.v1.md"
)
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--quality-eval-seed-report", type=Path, default=DEFAULT_QUALITY_EVAL_SEED_REPORT)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_parsed_artifact_evidence_chunk_answer_path_labs_opt_in_quality_eval_runner(
        ...
        quality_eval_seed_report_path=args.quality_eval_seed_report,
    )
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "parsed artifact evidence chunk labs opt-in quality eval runner schema validation failed: "
