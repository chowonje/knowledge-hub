#!/usr/bin/env python
"""Build the v0.1 text-evidence external action approval packet."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_rc_external_action_approval_packet.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_rc_external_action_approval_packet.v1.md"
