#!/usr/bin/env python
"""Build the v0.1 text-evidence canonical dirty inventory report."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_inventory.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_canonical_dirty_inventory.v1.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_text_evidence_canonical_dirty_inventory_report(canonical_repo=args.canonical_repo)
