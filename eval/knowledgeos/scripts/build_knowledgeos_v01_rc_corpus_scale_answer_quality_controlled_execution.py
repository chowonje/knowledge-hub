#!/usr/bin/env python3
"""Build the KnowledgeOS v0.1 RC corpus-scale answer quality controlled execution report."""
...
DEFAULT_MD_PATH = (
    PROJECT_ROOT
    / "eval/knowledgeos/reports/knowledgeos_v01_rc_corpus_scale_answer_quality_controlled_execution.v1.md"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_knowledgeos_v01_rc_corpus_scale_answer_quality_controlled_execution(
    ...
    if not validation.ok:
        ...
        raise ValueError(
            "KnowledgeOS v0.1 RC corpus-scale answer quality controlled execution schema validation failed: "
    ...
    # A blocked status is a valid outcome for this controlled-execution tranche:
    # it records the live answerability gap that the next repair tranche must fix.
    return 0
