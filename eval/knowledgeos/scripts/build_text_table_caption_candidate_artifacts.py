#!/usr/bin/env python
"""Build report-only table caption and table-like text candidates."""
...
from knowledge_hub.papers.visual_layout_candidate_list_report import default_paper_specs, default_papers_root
from knowledge_hub.papers.text_table_caption_candidate_artifacts import (
    build_text_table_caption_candidate_report,
    write_report,
)

DEFAULT_JSON_PATH = PROJECT_ROOT / "eval" / "knowledgeos" / "reports" / "text_table_caption_candidate_artifacts.v1.json"
DEFAULT_MD_PATH = PROJECT_ROOT / "eval" / "knowledgeos" / "reports" / "text_table_caption_candidate_artifacts.v1.md"
