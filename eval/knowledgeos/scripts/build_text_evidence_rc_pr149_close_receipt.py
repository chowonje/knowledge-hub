#!/usr/bin/env python
"""Build the v0.1 text-evidence RC PR #149 close receipt."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_rc_pr149_close_receipt.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_rc_pr149_close_receipt.v1.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    return 0 if report.get("status") in {"closed_verified", "pending_close_execution"} else 1
