#!/usr/bin/env python
"""Build the v0.1 text-evidence RC external action preflight."""
...
DEFAULT_JSON_PATH = REPORTS_ROOT / "text_evidence_rc_external_action_preflight.v1.json"
DEFAULT_MD_PATH = REPORTS_ROOT / "text_evidence_rc_external_action_preflight.v1.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    return 0 if report.get("status") == "ready_for_user_approval" else 1
