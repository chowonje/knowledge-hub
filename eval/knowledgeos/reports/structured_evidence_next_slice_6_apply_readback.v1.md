...
- generatedAt: 2026-05-21T07:32:48Z
- runId: structured-evidence-next-slice-20260521
- apply: true
- status: ready
- manifestRows: 300
- baselineStrictCoveredRows: 120
- strictCoveredRowsAfterLocalApply: 150
- readbackPassRows: 120
...
- snapshotStrictCoveredRows: **120**
- snapshotReadbackSourceIds: **120**
- snapshotGreenfieldSourceIds: **30**

## Greenfield Rows

- `2604.18845` status=`generated` applied=`True` postReadback=`pass`
- `2604.19295` status=`generated` applied=`True` postReadback=`pass`
- `2604.19638` status=`generated` applied=`True` postReadback=`pass`
- `2604.19656` status=`generated` applied=`True` postReadback=`pass`
- `2604.19667` status=`generated` applied=`True` postReadback=`pass`
- `2604.19728` status=`generated` applied=`True` postReadback=`pass`
- `2604.19734` status=`generated` applied=`True` postReadback=`pass`
- `2605.01148` status=`generated` applied=`True` postReadback=`pass`
- `2605.01203` status=`generated` applied=`True` postReadback=`pass`
- `2605.02363` status=`generated` applied=`True` postReadback=`pass`
- `2605.02364` status=`generated` applied=`True` postReadback=`pass`
- `2605.03476` status=`generated` applied=`True` postReadback=`pass`
- `2605.03534` status=`generated` applied=`True` postReadback=`pass`
- `2605.03667` status=`generated` applied=`True` postReadback=`pass`
- `2605.03808` status=`generated` applied=`True` postReadback=`pass`
- `2605.03838` status=`generated` applied=`True` postReadback=`pass`
- `2605.03862` status=`generated` applied=`True` postReadback=`pass`
- `2605.03871` status=`generated` applied=`True` postReadback=`pass`
- `2605.03903` status=`generated` applied=`True` postReadback=`pass`
- `2605.03986` status=`generated` applied=`True` postReadback=`pass`
- `2605.03989` status=`generated` applied=`True` postReadback=`pass`
- `2605.04036` status=`generated` applied=`True` postReadback=`pass`
- `2605.10616` status=`generated` applied=`True` postReadback=`pass`
- `attnres2026` status=`generated` applied=`True` postReadback=`pass`
- `2501.01765` status=`generated` applied=`True` postReadback=`pass`
- `2501.05031` status=`generated` applied=`True` postReadback=`pass`
- `2501.05366` status=`generated` applied=`True` postReadback=`pass`
- `2501.09004` status=`generated` applied=`True` postReadback=`pass`
- `2501.09136` status=`generated` applied=`True` postReadback=`pass`
- `2501.13956` status=`generated` applied=`True` postReadback=`pass`
