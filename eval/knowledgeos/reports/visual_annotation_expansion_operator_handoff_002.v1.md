...
- generatedAt: `2026-05-26T14:15:09Z`
- handoffId: `visual_annotation_expansion_operator_handoff_002`
- sourceManualRunPacket: `eval/knowledgeos/reports/visual_annotation_expansion_manual_run_packet_002.v1.json`
- expectedOutputRef: `eval/knowledgeos/reports/visual_annotation_expansion_web_output_002.manual.json`
...
5. Combine the returned rows into eval/knowledgeos/reports/visual_annotation_expansion_web_output_002.manual.json.
6. Run validation with: PYTHONPATH=. python eval/knowledgeos/scripts/validate_visual_annotation_expansion_web_output.py
